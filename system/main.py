...
from flcore.trainmodel.models import TextCNN
...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        if model_str == "mlr": # convex
            ...
            args.model = resnet18_cifar().to(args.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', "--model", type=str, default="TextCNN")
    parser.add_argument('-lbs', "--batch_size", type=int, default=10)
    parser.add_argument('-lr', "--local_learning_rate", type=float, default=0.9,
                        help="Local learning rate")
    parser.add_argument('-ld', "--learning_rate_decay", type=bool, default=False)
    parser.add_argument('-ldg', "--learning_rate_decay_gamma", type=float, default=0.9)
    parser.add_argument('-gr', "--global_rounds", type=int, default=100)
    
    parser.add_argument('-le', "--local_epochs", type=int, default=1, 
                        help="Multiple update steps in one local epoch.")
    parser.add_argument('-ls', "--local_steps", type=int, default=2,    #########2,4,6,8,10
                        help="Multiple update steps in one local epoch.")
    ...
    parser.add_argument('-mu', "--mu", type=float, default=1,help="Proximal rate for FedProx")
