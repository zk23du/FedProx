...
from flcore.optimizers.fedoptimizer import PerturbedGradientDescent, DFW
from flcore.clients.clientbase import Client
from flcore.optimizers.dfw import DFW1
from flcore.optimizers.dfw_testing import DFWP
from flcore.trainmodel.models import HingeLoss
...
class clientProx(Client):
    def __init__(self, args, id, train_samples, test_samples, **kwargs):
        ...
        self.optimizer = DFWP(self.model.parameters(),self.global_params, lr=0.1, momentum=0, mu = self.mu)
